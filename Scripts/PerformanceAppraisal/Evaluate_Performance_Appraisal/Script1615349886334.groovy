...
WebUI.click(findTestObject('Object Repository/PA/Evaluate_Performance_Appraisal/Page_ReviewMe/a_Start'))
...
WebUI.click(findTestObject('Object Repository/PA/Evaluate_Performance_Appraisal/Page_ReviewMe/input_Clear_btnSave'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/PA/Evaluate_Performance_Appraisal/Page_ReviewMe/button_OK'))
